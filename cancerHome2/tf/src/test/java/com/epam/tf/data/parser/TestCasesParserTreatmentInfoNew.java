...
/**
 * Created by Nikolay_Golubitsky on 12/12/2016.
 */
public class TestCasesParserTreatmentInfoNew extends Parser {

    private final static String SHEET = "Sheet1";

    public TestCasesParserTreatmentInfoNew(){
        super(SHEET);
    }
