...
public class SearchByCatalogPageSteps extends AbstractSteps {
    ...
    public SearchByCatalogPageSteps fillRequest(String firstRawDiagnosis,
                                                String secondRawAllRecords, String thirdRawCodmkb10, String fourthRawOmplice) {
    ...
    public void fillCatalogRequest(String firstLineCatalogLips,
                                      String secondLineCatalogLips, String thirdLineCatalogLips) {
